      ...
      <section className="section-spacing">
        <div className="section-container max-w-2xl">
          ...
          <div className="text-center">
            <p className="flex items-center justify-center gap-2 mb-2"><Mail className="h-4 w-4 text-primary" /> hello@bellebridal.com</p>
            <p className="text-sm text-muted-foreground mb-6">We typically respond within 24-48 hours.</p>
            <div className="flex justify-center gap-4">
              <a href="https://instagram.com" className="p-3 bg-secondary rounded-full"><Instagram className="h-5 w-5" /></a>
              <a href="https://facebook.com" className="p-3 bg-secondary rounded-full"><Facebook className="h-5 w-5" /></a>
            </div>
          </div>
        </div>
      </section>
