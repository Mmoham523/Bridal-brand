...
const testimonials = [
  {
    name: 'Emily R.',
    quote: 'The team at Belle Bridal made me feel like a princess. My dress fit perfectly and I received so many compliments.',
  },
  {
    name: 'Sophie L.',
    ...
    <>
      ...
      <section className="relative min-h-[90vh] flex items-center">
        <div className="absolute inset-0">
          <img
            src={heroImage}
            alt="Belle Bridal boutique interior with elegant wedding gowns"
        ...
        <div className="section-container relative z-10 py-20">
          ...
          >
            <motion.h1 variants={fadeInUp} className="heading-xl mb-6">
              Bridal wear made to fit beautifully
            </motion.h1>
            <motion.p variants={fadeInUp} className="body-lg mb-10 max-w-lg">
              Shop timeless pieces or book a bridal sizing consultation. Every gown crafted to celebrate your unique love story.
            </motion.p>
      ...
      <section className="section-spacing bg-primary">
        <div className="section-container text-center">
          ...
          >
            ...
            <motion.p variants={fadeInUp} className="body-md max-w-2xl mx-auto mb-8">
